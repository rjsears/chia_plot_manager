 <h2 align="center">
  ...
  Chia Plot, Drive Manager, Coin Monitor & Auto Drive (V0.9 - May 28th, 2021)
  </h2>
  <p align="center">
...
Before we get too deep into the installation and configuration of the scripts, I want to explain how ```I``` have my servers and network setup. Everything you read or see here will be based on this network diagram. If you have multiple Harvesters, they would connect the same way the first one does. Something to note, you absolutely should separate your Harvester/NAS traffic from your plotter and that of your farmer traffic to and from your Harvesters. Failure to do so can result in link saturation during plot transfers and your main node falling offline as a result.<br><br> On the plotter I put host entries in ```/etc/hosts``` for the <em>INTERNAL</em> ip address of each of the Harvesters/NAS. I use 10Gbe connections on the back and I want all of the plots to be mvoed across this network. By creating a separate network (10.200.95.x/24 in my example) wihtout a default gateway, I can guarantee the only traffic on that network is plots being moved around and nothing else. 
