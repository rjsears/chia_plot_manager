...
As the title implies, I designed this script to help with the adding of new hard drives to yuor Chia Harvester/NAS. This is a command line drive interactive python script. Please see the top fo the script for more information. 
